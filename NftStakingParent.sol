...
import "@net2devcrypto/nftstaking/IERC20.sol";
import "@net2devcrypto/nftstaking/ERC1155TokenReceiver.sol";
 ...
 */
abstract contract NftStakingParent is ERC1155TokenReceiver, Ownable {
     ...
     * @dev Warning: cycles and periods need to be calibrated carefully. Small values will increase computation load while estimating and 
            claiming rewards. Big values will increase the time to wait before a new period becomes claimable.
     * @param cycleLengthInSeconds_ The length of a cycle, in seconds.
     * @param periodLengthInCycles_ The length of a period, in cycles.
     * @param whitelistedNftContract_ The ERC1155-compliant (optional ERC721-compliance) contract from which staking 
                                      is accepted.
    ...
    constructor(
        ...
        cycleLengthInSeconds_ = 3600;
        periodLengthInCycles_ = 4;
        rewardsTokenContract_ = IERC20(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
        whitelistedNftContract_ = IERC1155721Transferrable(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
    ...
    /**
     * Adds `rewardsPerCycle` reward amount for the period range from `startPeriod` to `endPeriod`, inclusive, 
       to the rewards schedule.
